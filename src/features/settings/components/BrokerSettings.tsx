                    ...
                    <div className="w-full max-w-md bg-[#1C1E22] rounded-3xl border border-white/10 shadow-3xl overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div className="p-5 space-y-6 overflow-y-auto custom-scrollbar">
                            ...
                            <div className="relative pl-10">
                                <div className="absolute -left-1 -top-2 text-4xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white/70 to-transparent opacity-50 select-none pointer-events-none font-sans">1</div>
                            ...
                            {/* STEP 2: 輸入 API 資訊 */}
                            <div className="relative pl-10">
                                <div className="absolute -left-1 -top-2 text-4xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white/70 to-transparent opacity-50 select-none pointer-events-none font-sans">2</div>
                                <div className="relative z-10 pt-1">
                            ...
                            {/* STEP 3: 匯入憑證 */}
                            <div className="relative pl-10">
                                <div className="absolute -left-1 -top-2 text-4xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white/70 to-transparent opacity-50 select-none pointer-events-none font-sans">3</div>
                                <div className="relative z-10 pt-1">
