                ...
                <div className="flex justify-between items-center mb-2 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                        <button 
                            ...
                            className={`
                                h-[32px] px-4 flex items-center justify-center rounded-full border transition-all duration-300 backdrop-blur-md shrink-0 text-[10px] font-bold tracking-wider
                                ${showPurePnl 
